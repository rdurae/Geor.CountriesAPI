...
namespace Geor.CountriesAPI.Migrations
{
    ...
    [Migration("20230310200849_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Geor.CountriesAPI.Application.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Geor.CountriesAPI.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Geor.CountriesAPI.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Geor.CountriesAPI.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Geor.CountriesAPI.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Geor.CountriesAPI.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Geor.CountriesAPI.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Geor.CountriesAPI.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Geor.CountriesAPI.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Geor.CountriesAPI.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
