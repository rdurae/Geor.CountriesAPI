...
{
    public abstract class CountriesAPIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CountriesAPIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CountriesAPIWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CountriesAPIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CountriesAPIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CountriesAPIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CountriesAPIDbContext, Task<T>> func)
        {
            T result;
